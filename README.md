...
Communication to the Raspberry Pi will be driven by the ESP32, sending packets as follows:

1 byte: packet type (0 = data, all others: alert)

Non-data: 6 byte MAC address (source of alert)
